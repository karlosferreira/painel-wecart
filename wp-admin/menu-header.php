...
<div class="logo-box">
	<img src="<?php echo get_theme_root_uri().'/wecart/assets/img/logo.png'; ?>" alt="">
</div>
<h3><?php $nickname = get_user_meta( wp_get_current_user()->ID, 'nickname', true ); print_r($nickname)?></h3>
<ul id="adminmenu">
	<style>
		.logo-box img {
			width: 135px;
